...
class Prediction(Base):
    __tablename__ = "epikdoc_predictions"
...
class Label(Base):
    __tablename__ = "epikdoc_labels"

    id: Mapped[str] = mapped_column(String(36), primary_key=True, unique=True, default=generate_uuid, nullable=False)
    prediction_id: Mapped[str] = mapped_column(String(36), ForeignKey("epikdoc_predictions.id"), nullable=False)
...
class DeletedLabel(Base):
    __tablename__ = "epikdoc_deleted_labels"

    id: Mapped[str] = mapped_column(String(36), primary_key=True, unique=True, default=generate_uuid, nullable=False)
    label_id: Mapped[str] = mapped_column(String(36), ForeignKey("epikdoc_labels.id"), nullable=False)
